...
//	}
    ...
    private void CarregarListaElementos() {
    	try {
			...
			for (Reacao reac : this.listaReactions) {
		        ...
		        for (String comp : compsEduto) {
		        	...
		        	if (compExistente != null) {
						System.out.println("J� est� inclu�do: " + comp);
			...
			System.out.println("N�mero de rea��es: " + numR);
	        System.out.println("N�mero de metab�litos: " + numM);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
    }

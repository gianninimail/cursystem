...
public class DesafioBean {
	...
	public void ExcluirDesafio() {
		try {
			...
			JSFUtil.adicionarMensagemSucesso("Desafio exclu�do com sucesso!");
	...
	public void ExcluirResposta() {
		try {
			...
			JSFUtil.adicionarMensagemSucesso("Resposta exclu�da com sucesso!");
			
		} catch (MySQLIntegrityConstraintViolationException e) {
			e.printStackTrace();
			JSFUtil.adicionarMensagemErro("Verifique se n�o existe coment�rios cadastrados para esse resposta");
		} catch (Exception e) {
			e.printStackTrace();
			JSFUtil.adicionarMensagemErro(e.getMessage());
		}
	...
	public void EnviarEmail() {
		...
		try {
			...
			String msg = "Dados do Desafio: \n"
				...
				+ "\nDescri��o do desafio: " + this.desafio.getDesc()
				+ "\nRea��o envolvida no desafio: " + this.desafio.getReacao().getAbbreviation() + "  |--|  Eq:" + this.desafio.getReacao().getEquation()
				+ "";
